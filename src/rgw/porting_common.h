...
struct RGWAccessKey {
  ...
  void dump(Formatter *f) const{};//mdf
  void dump_plain(Formatter *f) const{};//mdf
  void dump(Formatter *f, const string& user, bool swift) const{};//mdf
  static void generate_test_instances(list<RGWAccessKey*>& o){};//mdf

  void decode_json(JSONObj *obj){};//mdf
  void decode_json(JSONObj *obj, bool swift){};//mdf
};
...
struct RGWSubUser {
  ...
  void dump(Formatter *f) const{};//mdf
  void dump(Formatter *f, const string& user) const{};//mdf
  static void generate_test_instances(list<RGWSubUser*>& o){};//mdf
